[![CI-CD](https://github.com/aarong/feedme-client/actions/workflows/built-test-deploy.yml/badge.svg)](https://github.com/aarong/feedme-client/actions/workflows/built-test-deploy.yml)
...
- [Feedme Javascript Client](#feedme-javascript-client)
...
- `err.message === "INVALID_MESSAGE: ..."` - The server transmitted a message
  ...
  - `err.serverMessage` (JSON value) The message received from the server. If
