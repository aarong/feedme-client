...
//     it("options.transport - invalid transport.on/addListener/addEventListener types", async () => {
//       const trace = await harness.trace(() => {
//         harness.initClient({
//           transport: {
//             off: () => {},
...
//     it("options.transport - invalid transport.off/removeListener/removeEventListener types", async () => {
//       const trace = await harness.trace(() => {
//         harness.initClient({
//           transport: {
//             on: () => {},
...
//     it("options.transport - transport event subscriber throws", async () => {
//       const trace = await harness.trace(() => {
//         harness.initClient({
//           transport: {
//             state: () => "disconnected",
